    ...
    <section className="py-2 bg-white shadow-gray-400">
      <div className="container mx-auto px-4">
        <div className="relative bg-gray-800 text-white rounded-lg shadow-gray-400 shadow-md overflow-hidden">
          <video src={join} alt="Children smiling and playing" className="w-full h-64 object-cover opacity-50"autoPlay
      muted
      loop/>
          <div className="absolute inset-0 p-6 flex flex-col justify-center items-center">
            ...
            <div className="mt-4 flex space-x-4">
              <button className="bg-yellow-500 text-gray-800 px-4 py-2 rounded font-semibold">Join as a volunteer!</button>
              <button className="bg-white text-gray-800 px-4 py-2 rounded font-semibold">Contribute</button>
            </div>
          </div>
        </div>
      </div>
