                ...
                <nav className="h-full w-full flex flex-col bg-white border-r shadow-sm">
                    ...
                    <SidebarContext.Provider value={{ expanded }}>
                        <ul className="flex-1 px-3">
                            {/* Sidebar Items */}
                            <Link to='/dashboard'><SidebarItem icon={<Grid className="text-red-500 " />} text="Dashboard" /></Link>
                            <Link to='/dashboard/game'><SidebarItem icon={<BookOpen className="text-red-500" />} text="Training" /></Link>
                            <Link to='/dashboard/rewards'><SidebarItem icon={<BookOpen className="text-red-500" />} text="Rewards" /></Link>
                        </ul>
